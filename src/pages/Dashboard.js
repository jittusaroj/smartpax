          ...
          <div className="page-content">
            <div className="row">
              <div className="col-12 col-lg-8 col-md-8 col-sm-12 inbox">
                <div>
                  <p className="float-right">
                    {" "}
                    <i className="bx bx-heart"></i> Send Feedback
                  </p>
                </div>
                ...
                <div>
                  <p className="open-text">
                    {" "}
                    <b>open(1)</b>/All Update
                  </p>
                </div>
                <br />
                <div>
                  <button className="btn btn-primary float-right ms-2 px-1">
                    <i className="bx bx-check fs-1"></i>
                  </button>
                </div>
                <div className="card inbox-card">
                  ...
                  <div className="d-flex pl-20">
                    ...
                    <span className="usertext">
                      Lot Stuart happy birthday to you Michael, wish you all the
                      best this day unfolds for you
                    </span>
                  </div>
                  <br />
                  <div className="pl-20">
                    <i className="bx bx-timer"> </i> 20days| 13{" "}
              ...
              <div className="col-md-3 col-sm-12 col-lg-3 col-12">
                ...
                <span>
                  Update without Board <span className="float-right">1</span>
                </span>
              </div>
            </div>
